...
export interface DashboardReserva {
  id_reserva:number; codigo_reserva?:string|null; fecha_solicitud?:string|null; fecha_aprobacion?:string|null; fecha_reserva?:string|null; telefono_cliente?:string|null;
